...
import com.zdm.download.M3u8DownloadFactory;
import com.zdm.listener.DownloadListener;
import com.zdm.utils.Constant;
...
public class M3u8Main {
    ...
    private static final String M3U8URL = "https://devstreaming-cdn.apple.com/videos/streaming/examples/bipbop_4x3/bipbop_4x3_variant.m3u8";

    public static void main(String[] args) {

        M3u8DownloadFactory.M3u8Download m3u8Download = M3u8DownloadFactory.getInstance(M3U8URL);
        //设置生成目录
        m3u8Download.setDir("Users/wangsiwei/Desktop");
        //设置视频名称
